...
const didRegisterSkillViewsEmitTargetAndPayloadSchema: SpruceSchemas.Heartwood.v2021_02_11.DidRegisterSkillViewsEmitTargetAndPayloadSchema =
    {
        ...
        fields: {
            ...
            target: {
                ...
                isRequired: true,
                options: {
                    schema: didRegisterSkillViewsEmitTargetSchema_v2021_02_11,
                },
            },
            /** . */
            payload: {
                ...
                isRequired: true,
                options: {
                    schema: didRegisterSkillViewsEmitPayloadSchema_v2021_02_11,
                },
            },
        },
    }
...
SchemaRegistry.getInstance().trackSchema(
    didRegisterSkillViewsEmitTargetAndPayloadSchema
)
